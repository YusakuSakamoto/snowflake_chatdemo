# [[design.RESOLVE_ENTITY_ALIAS_TOOL]] 設計書
...
- [[design.RESOLVE_ENTITY_ALIAS]]: 実際の名称解決ロジックを実行するプロシージャ
- [[design.SNOWFLAKE_DEMO_AGENT]]: 本ツールをresolve_entity_aliasツールとして登録し、自然言語質問から抽出した固有名詞の解決に使用
