# [[design.LIST_SCHEMA_RELATED_DOC_PATHS_AGENT]] 設計書
...
- スキーマレビューのドキュメント範囲確定: [[DB_DESIGN.OBSIDIAN_SCHEMA_DB_DESIGN_REVIEW_AGENT]]が最初に本プロシージャを呼び出し、対象スキーマのドキュメントPATHリストを取得
