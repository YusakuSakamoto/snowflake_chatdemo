...
CREATE OR REPLACE SCHEMA RAKURAKU;
COMMENT ON SCHEMA RAKURAKU IS '楽楽販売';
...
CREATE OR REPLACE TABLE RAKURAKU.ANKEN_MEISAI (
...
COMMENT ON TABLE RAKURAKU.ANKEN_MEISAI IS '案件明細CSV取込用テーブル';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.ACCOUNTING_MONTH IS '計上月度';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.ACTIVE_FLAG IS '有効無効フラグ';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.AMOUNT IS '金額';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.BRANCH_NUMBER IS '枝番';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.CUSTOMER_ID IS '取引先ID';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.CUSTOMER_NAME IS '取引先名';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.CUSTOMER_ORDER_NUMBER IS '顧客注文番号';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.CUSTOMER_QUOTE_REQUEST_NUMBER IS '顧客見積依頼番号';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.DEPARTMENT_ID IS '部署ID';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.DEPARTMENT_NAME IS '部署名';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.DEPARTMENT_SECTION_SHORT_NAME IS '部課名（略称）';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.DEPARTMENT_SHORT_NAME IS '部名（略称）';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.DIVISION_CODE IS '部門CD';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.FISCAL_YEAR IS '年度';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.GROUP_SHORT_NAME IS 'グループ名（略称）';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.ID IS 'レコードID';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.INVOICE_NUMBER IS '請求番号';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.ORDER_NAME IS 'オーダ名';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.ORDER_NUMBER IS 'オーダ番号';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.PROJECT_NAME IS '案件名';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.PROJECT_NUMBER IS '案件番号';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.RANK IS 'ランク';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.SALES_CATEGORY IS '売上区分';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.SALES_DELIVERY_FLAG IS '売上渡しフラグ';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.SECTION_NAME IS '課名（正式）';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.SUBJECT IS '件名';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.WORK_END_DATE IS '作業終了日';
COMMENT ON COLUMN RAKURAKU.ANKEN_MEISAI.WORK_START_DATE IS '作業開始日';

CREATE OR REPLACE TABLE RAKURAKU.DEPARTMENT_MASTER (
...
COMMENT ON TABLE RAKURAKU.DEPARTMENT_MASTER IS '部署マスタ（年度別）CSV取込用テーブル';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.ACCOUNTING_DEPARTMENT_CODE IS '経理部門CD';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.COMBINED_NAME IS '組合せ名称';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.COMBINED_SHORT_NAME IS '組合せ略称';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.DEPARTMENT_CATEGORY IS '部署区分';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.DEPARTMENT_CODE IS '部CD';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.DEPARTMENT_ID IS '部署ID';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.DEPARTMENT_SECTION_CODE IS '部課CD';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.DIVISION_CODE IS '部門CD';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.FISCAL_YEAR IS '年度';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.FULL_NAME IS '正式名称';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.GENERAL_DEPARTMENT_CODE IS '統括部CD';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.GROUP_CODE IS 'グループCD';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.HEADQUARTERS_CODE IS '本部CD';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.ID IS 'レコードID';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.SECTION_CODE IS '課CD';
COMMENT ON COLUMN RAKURAKU.DEPARTMENT_MASTER.SHORT_NAME IS '略称';
...
WITH LATEST AS (
  ...
  FROM SAKAMOTO_DB.DB_DESIGN.PROFILE_RUNS
  WHERE STATUS = 'SUCCEEDED'
  GROUP BY 1,2,3
),
LATEST_RUN AS (
  SELECT r.*
  FROM SAKAMOTO_DB.DB_DESIGN.PROFILE_RUNS r
  JOIN LATEST l
...
SELECT
  ...
  pr.AS_OF_AT,
  pr.METRICS
FROM SAKAMOTO_DB.DB_DESIGN.PROFILE_RESULTS pr
JOIN LATEST_RUN lr
  ON pr.RUN_ID = lr.RUN_ID;;

CREATE OR REPLACE VIEW RAKURAKU.V_CUSTOMER_MASTER (
...
CREATE OR REPLACE VIEW RAKURAKU.V_ORDER_MASTER (
...
CREATE OR REPLACE VIEW RAKURAKU.V_INVOICE (
...
CREATE OR REPLACE VIEW RAKURAKU.V_PROJECT_FACT (
  ID COMMENT 'レコードID',
  PROJECT_NUMBER COMMENT '案件番号',
  BRANCH_NUMBER COMMENT '枝番',
  FISCAL_YEAR COMMENT '年度',
...
CREATE OR REPLACE VIEW RAKURAKU.V_PROJECT_MASTER (
  PROJECT_NUMBER COMMENT '案件番号',
  BRANCH_NUMBER COMMENT '枝番',
  FISCAL_YEAR COMMENT '年度',
...
';
  ...
  FOR REC IN V_TBL_RS DO
    ...
    BEGIN
      V_SQL_CALL := '
CALL SAKAMOTO_DB.DB_DESIGN.PROFILE_TABLE(
  ''' || REPLACE(P_TARGET_DB,'''','''''') || ''',
...
BEGIN
  ...
  /* ========== RUN 登録（冪等） ========== */
  MERGE INTO SAKAMOTO_DB.DB_DESIGN.PROFILE_RUNS T
  USING (
    SELECT
      :V_RUN_ID        AS RUN_ID,
  ...
  /* ========== 再実行対策：既存結果削除 ========== */
  DELETE FROM SAKAMOTO_DB.DB_DESIGN.PROFILE_RESULTS
...
';
    ...
    INSERT INTO SAKAMOTO_DB.DB_DESIGN.PROFILE_RESULTS
      (RUN_ID, TARGET_DB, TARGET_SCHEMA, TARGET_TABLE,
  ...
  /* ========== RUN 正常終了 ========== */
  UPDATE SAKAMOTO_DB.DB_DESIGN.PROFILE_RUNS
...
-- PROCEDURE: RAKURAKU.EXPAND_DEPARTMENT_SCOPE_TOOL
create or replace procedure RAKURAKU.EXPAND_DEPARTMENT_SCOPE_TOOL(
  payload_json string
)
returns variant
language javascript
...
try {
  ...
  if (!fy) {
    const rsFy = q1("select max(FISCAL_YEAR) from SAKAMOTO_DB.RAKURAKU.DEPARTMENT_MASTER", []);
  ...
  let rsRoot = q1(`
    select
      ...
      COMBINED_NAME,
      COMBINED_SHORT_NAME
    from SAKAMOTO_DB.RAKURAKU.DEPARTMENT_MASTER
    where FISCAL_YEAR = ?
      and DEPARTMENT_ID = ?
    limit 1
  `, [fy, deptId]);
...
-- FUNCTION: RAKURAKU.NORMALIZE_JA
create or replace function RAKURAKU.NORMALIZE_JA(s string)
returns string
language javascript
as
$$
...
-- FUNCTION: RAKURAKU.NORMALIZE_JA_DEPT
create or replace function RAKURAKU.NORMALIZE_JA_DEPT(s string)
returns string
language javascript
as
$$
...
-- STAGE: RAKURAKU.RAW_DATA
CREATE OR REPLACE STAGE RAKURAKU.RAW_DATA
  ENCRYPTION = (TYPE = 'SNOWFLAKE_SSE')
  DIRECTORY = (ENABLE = TRUE);

-- PROCEDURE: RAKURAKU.RESOLVE_ENTITY_ALIAS
create or replace procedure RAKURAKU.RESOLVE_ENTITY_ALIAS(
    term string,
...
try {
  ...
  const normJa = firstValue(
    q1("select SAKAMOTO_DB.RAKURAKU.NORMALIZE_JA(?)", [t])
  );

  const normDept = firstValue(
    q1("select SAKAMOTO_DB.RAKURAKU.NORMALIZE_JA_DEPT(?)", [t])
  );
...
-- PROCEDURE: RAKURAKU.RESOLVE_ENTITY_ALIAS_TOOL
create or replace procedure SAKAMOTO_DB.RAKURAKU.RESOLVE_ENTITY_ALIAS_TOOL(payload_json string)
returns variant
language javascript
execute as owner
as
...
try {
  ...
  const st = snowflake.createStatement({
    sqlText: `call SAKAMOTO_DB.RAKURAKU.RESOLVE_ENTITY_ALIAS(?, ?, ?)`,
...
-- AGENT: RAKURAKU.SNOWFLAKE_DEMO_AGENT
CREATE OR REPLACE AGENT SNOWFLAKE_DEMO_AGENT
...
tool_resources:
  resolve_entity_alias:
    ...
    execution_environment:
      type: "warehouse"
      warehouse: "SAKAMOTO_WH"
      query_timeout: 60
    identifier: "SAKAMOTO_DB.RAKURAKU.RESOLVE_ENTITY_ALIAS_TOOL"
  ...
  expand_department_scope:
    ...
    execution_environment:
      ...
      warehouse: "SAKAMOTO_WH"
      query_timeout: 60
    identifier: "SAKAMOTO_DB.RAKURAKU.EXPAND_DEPARTMENT_SCOPE_TOOL"

  text_to_sql:
    semantic_model_file: "@SAKAMOTO_DB.RAKURAKU.RAW_DATA/test.yaml"
    execution_environment:
      type: "warehouse"
      warehouse: "SAKAMOTO_WH"
      query_timeout: 60
...
tool_resources:
  list_schema_related_doc_paths:
    ...
    execution_environment:
      ...
      warehouse: "SAKAMOTO_WH"
      query_timeout: 300
    identifier: "SAKAMOTO_DB.DB_DESIGN.LIST_SCHEMA_RELATED_DOC_PATHS_AGENT"
  ...
  list_table_related_doc_paths:
    ...
    execution_environment:
      ...
      warehouse: "SAKAMOTO_WH"
      query_timeout: 300
    identifier: "SAKAMOTO_DB.DB_DESIGN.LIST_TABLE_RELATED_DOC_PATHS_AGENT"
  ...
  get_docs_by_paths:
    ...
    execution_environment:
      ...
      warehouse: "SAKAMOTO_WH"
      query_timeout: 300
    identifier: "SAKAMOTO_DB.DB_DESIGN.GET_DOCS_BY_PATHS_AGENT"
$$;
...
BEGIN
  ...
  IF (v_inc_cols) THEN
    ...
    FROM (
      SELECT d.PATH
      FROM SAKAMOTO_DB.DB_DESIGN.DOCS_OBSIDIAN_V d
...
BEGIN
  ...
  hit AS (
    ...
    FROM req r
    LEFT JOIN SAKAMOTO_DB.DB_DESIGN.DOCS_OBSIDIAN_V d
