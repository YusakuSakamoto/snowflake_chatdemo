...
CREATE OR REPLACE SCHEMA LOG;
COMMENT ON SCHEMA LOG IS 'アプリケーションログ集約（S3外部ステージ）';
...
CREATE OR REPLACE TABLE NAME_RESOLUTION.DIM_ENTITY_ALIAS (
...
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS.refresh_run_id IS 'refresh実行単位の識別子（timestampやUUID）';

CREATE OR REPLACE TABLE NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL (
  ALIAS_NORMALIZED VARCHAR NOT NULL,
...
COMMENT ON TABLE NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL IS '人手で管理するエンティティ別名テーブル（AUTO生成で拾えない略称・社内用語・例外対応用）';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.ALIAS_NORMALIZED IS 'NORMALIZE_JA / NORMALIZE_JA_DEPT 適用後の文字列';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.ALIAS_RAW IS '人が入力・承認した別名（例: DI, デジイノ, 本社DI）';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.CONFIDENCE IS 'この別名の信頼度（0.0〜1.0、人手追加は0.6〜0.8推奨）';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.CREATED_BY IS '追加したユーザー/システム名';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.ENTITY_ID IS '対応するマスタのID（共通利用のためvarchar）';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.ENTITY_NAME IS '正式名称（UI表示・確認用）';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.ENTITY_TYPE IS 'department / customer / project / order';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.IS_ACTIVE IS 'falseで無効化（削除せず履歴保持）';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.NOTE IS '補足（由来、使いどころ、注意点など）';
COMMENT ON COLUMN NAME_RESOLUTION.DIM_ENTITY_ALIAS_MANUAL.PRIORITY IS '小さいほど優先（MANUALはAUTOより必ず小さく）';
...
CREATE OR REPLACE VIEW DB_DESIGN.V_DOCS_OBSIDIAN (
...
SELECT
  ...
  pr.AS_OF_AT,
  pr.METRICS
FROM DB_DESIGN.PROFILE_RESULTS pr
JOIN LATEST_RUN lr
...
-- 売上・請求分析向けセマンティックモデル（らくらく案件データ正規化VIEW群）
-- ファイル出力先: SV_SALES.yaml
/*
name: SV_SALES
...
BEGIN
  ...
  hit AS (
    ...
    FROM req r
    LEFT JOIN DB_DESIGN.V_DOCS_OBSIDIAN d
...
-- WARNINGS
-- ==============================
-- column_id=EXT_20251226181951 unknown table_id=TBL_20260102230002
-- column_id=COL_20260102000313 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000307 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000309 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000302 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000314 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000303 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000304 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000301 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000305 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000310 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000312 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000308 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000306 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000311 unknown table_id=TBL_20260102000102
-- column_id=COL_20260102000410 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000414 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000415 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000411 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000401 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000406 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000413 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000409 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000402 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000403 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000407 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000408 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000405 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000412 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000204 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000404 unknown table_id=TBL_20260102000103
-- column_id=COL_20260102000201 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000211 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000212 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000205 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000206 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000208 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000210 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000202 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000207 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000203 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000209 unknown table_id=TBL_20260102000101
-- column_id=COL_20260102000511 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000512 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000508 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000501 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000502 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000503 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000510 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000505 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000507 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000506 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000504 unknown table_id=TBL_20260102000104
-- column_id=COL_20260102000509 unknown table_id=TBL_20260102000104
